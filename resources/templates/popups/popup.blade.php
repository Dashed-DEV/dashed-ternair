<div x-data="{ showTernair: @entangle('showTernair'), show: false }" x-init="setTimeout(() => show = true, {{ $ternair->delay * 1000 }})"
     x-show="show && showTernair">
            ...
            <div class="text-center grid lg:flex lg:items-center lg:justify-between gap-4">
                <div class="absolute left-[25px] lg:left-[50px] xl:left-[100px] -bottom-4 lg:bottom-0">
                    ...
                    <x-drift::image
                        ...
                        config="dashed"
                        :path="Translation::get('ternair-image', 'ternair-' . $ternair->name, '', 'image')"
                        alt=""
                        :manipulations="[
                                                        'widen' => 500,
                                                    ]"
                ...
                <div
                    class="mx-auto lg:ml-[250px] xl:ml-[350px] text-md lg:text-lg xl:text-xl text-white font-bold max-w-[600px] ternair-description">
                    {!! Translation::get('ternair-description', 'ternair', 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industrys standard dummy text ever since the 1500s', 'text', [
    'phoneNumber' => Customsetting::get('company_phone_number'),
                ...
                <div class="lg:mr-[150px] flex flex-col gap-2">
                    <div class="flex gap-2 items-center justify-center">
                        <x-drift::image
                            ...
                            config="dashed"
                            :path="Translation::get('review-image', 'ternair-' . $ternair->name, '', 'image')"
                            alt=""
                            :manipulations="[
                                    'widen' => 500,
                                ]"
        ...
        <script>
            document.addEventListener('redirectTo', () => {
                window.open('{{ Translation::get('redirect-url', 'ternair-' . $ternair->name, '') }}', '_blank').focus();
            })
        </script>
    </div>
